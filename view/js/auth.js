...
if (domElements.loginIcon && domElements.authOverlay && domElements.closeAuthBtn) {
    ...
    domElements.backToAuthInitialFromLoginBtn.addEventListener('click', (e) => { e.preventDefault(); goBackToAuthInitial(); });
    domElements.backToAuthInitialFromSignupBtn.addEventListener('click', (e) => { e.preventDefault(); goBackToAuthInitial(); });
